...
description: Batch processing began with mainframe computers and punch cards. Today,
  ...
  that require running lots of automated tasksmdash;processing bills and payroll,
...
- name: Azure Batch API Location Get Quotas
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/quotas/master/_listings/azure-batch/subscriptions-subscriptionid-providers-microsoft-batch-locations-locationname-quotas-get-postman.md
x-common:
